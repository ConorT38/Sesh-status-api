...
public class Status {
    ...
    public Status(int id, int user_id, String username, String first_name, String last_name, String message, int location, int likes, boolean liked, Timestamp date, String going, String maybe, String not_going) {
        this.id = id;
