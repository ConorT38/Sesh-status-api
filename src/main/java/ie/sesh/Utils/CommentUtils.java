...
public class CommentUtils {
  ...
  public Comment buildComment(String comment_data) {
    int status_id = Integer.parseInt(CommonUtils.parseStringFromJSON(comment_data, "status_id"));
    int user_id = Integer.parseInt(CommonUtils.parseStringFromJSON(comment_data, "user_id"));
